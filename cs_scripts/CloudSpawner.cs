...
public class CloudSpawner : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        { 
            ...
            clouds_overhead_player = is_pc_undercloud(pc) / 3f;
        ...
        {  
            // For each glider
            // Check if plane(s) somewhere under a cloud
            clouds_overhead_player = is_gc_undercloud(gc) / 10f;
